...
Martin Rehfeld\
{{ site.subtitle | escape_once }}\
Kameruner Weg 18\
14641 Paulinenaue

## Kontakt

Telefon: {{ site.telephone | escape_once }}\
Telefax: +49 (0) 30 454 821 68\
E-Mail: {{ site.email | escape_once }}
...
Die Europäische Kommission stellt eine Plattform zur Online-Streitbeilegung (OS) bereit: [https://ec.europa.eu/consumers/odr](https://ec.europa.eu/consumers/odr).\
...
![eRecht24 - Impressum für rechtssichere Webseiten]({{ "/assets/img/erecht_impressum.png?v=" | append: site.github.build_revision | relative_url }})